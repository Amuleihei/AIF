...
- 核心 UI 风格与交互手感属于系统级资产，与三语环境同级维护
...
- 多语言与简写命令识别
- 核心交互风格默认追求“轻、快、稳、顺手”，优先采用就地操作、气泡、浮层、局部反馈
...
- UI 核心原则：`AIF_UI_CORE_PRINCIPLES.md`
...
- Core UI feel and interaction quality are treated as system assets at the same level as trilingual support
...
- Preferred interaction style: light, fast, stable, direct, with local actions, bubbles, sheets, and contextual feedback
...
- UI core principles: `AIF_UI_CORE_PRINCIPLES.md`
...
- Core UI style နှင့် interaction feel ကိုလည်း သုံးဘာသာပတ်ဝန်းကျင်နဲ့ တန်းတူ system asset အဖြစ် ထိန်းသိမ်းမည်
...
- UI interaction ကို light, fast, stable, direct ပုံစံနဲ့ တည်ဆောက်ပြီး bubble / sheet / inline action များကို ဦးစားပေးသည်
