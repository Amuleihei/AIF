...
CN_TO_MM = {
    ...
    "员工": "ဝန်ထမ်း",
    "员工列表": "ဝန်ထမ်းစာရင်း",
    "员工档案": "ဝန်ထမ်းမှတ်တမ်း",
    "员工建档": "ဝန်ထမ်းမှတ်တမ်းတင်",
    "员工离职": "ဝန်ထမ်းအလုပ်ထွက်",
    "员工复职": "ဝန်ထမ်းအလုပ်ပြန်ဝင်",
    "考勤": "တက်ရောက်မှု",
    "出勤": "အလုပ်ဆင်းရက်",
    "工时": "လုပ်ချိန်",
    "加班": "အချိန်ပို",
...
CN_TO_EN = {
    ...
    "员工建档": "Create Employee Profile",
    "员工离职": "Employee Resignation",
    "员工复职": "Employee Rehire",
    "考勤": "Attendance",
    "出勤": "Attendance Days",
    "工时": "Work Hours",
    "加班": "Overtime",
