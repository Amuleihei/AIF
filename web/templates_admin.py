...
ADMIN_HR_ATTENDANCE_TEMPLATE = _load_template_file("admin_hr_attendance.html")
ADMIN_FINANCE_TEMPLATE = _load_template_file("admin_finance.html")
ADMIN_AUDIT_TEMPLATE = _load_template_file("admin_audit.html")
ADMIN_TRACEABILITY_TEMPLATE = _load_template_file("admin_traceability.html")


__all__ = ['ADMIN_USERS_TEMPLATE', 'ADMIN_DASHBOARD_TEMPLATE', 'ADMIN_AUDIT_TEMPLATE', 'ADMIN_ALERT_SETTINGS_TEMPLATE', 'ADMIN_ALERT_CENTER_TEMPLATE', 'ADMIN_HR_SETTINGS_TEMPLATE', 'ADMIN_HR_EMPLOYEES_TEMPLATE', 'ADMIN_HR_ATTENDANCE_TEMPLATE', 'ADMIN_FINANCE_TEMPLATE', 'ADMIN_TRACEABILITY_TEMPLATE']
